    ...
    <div class="shop-layout">
      ...
      <div class="product-grid-wrap">
        ...
        <div class="products-grid" id="productsGrid">
          ...
          <!-- PRODUCT 1 -->
          <div class="product-card" data-price="649" data-concern="acne pigmentation" data-ingredient="Ceramides"
          ...
          <!-- PRODUCT 2 -->
          <div class="product-card" data-price="699" data-concern="pigmentation" data-ingredient="Glycerin"
            data-type="lotus_moisturizers">
            <div class="product-img-wrap">
          ...
          <!-- PRODUCT 3 -->
          <div class="product-card" data-price="699" data-concern="brightening" data-ingredient="Ceramides"
            data-type="lotus_moisturizers">
            <div class="product-img-wrap">
          ...
          <!-- PRODUCT 4 -->
          <div class="product-card" data-price="699" data-concern="eczema" data-ingredient="Hyaluronic "
            data-type="lotus_moisturizers">
            <div class="product-img-wrap">
          ...
          <!-- PRODUCT 5 -->
          <div class="product-card" data-price="649" data-concern="acne" data-ingredient="Hyaluronic"
            data-type="lotus_moisturizers">
            <div class="product-img-wrap">
          ...
          <!-- PRODUCT 6 -->
          <div class="product-card" data-price="495" data-concern="acne" data-ingredient="panthenol"
            data-type="facial-cleansers">
            <div class="product-img-wrap">
          ...
          <!-- PRODUCT 7 -->
          <div class="product-card" data-price="649" data-concern="hydration" data-ingredient="panthenol"
            data-type="lotus_moisturizers">
            <div class="product-img-wrap">
