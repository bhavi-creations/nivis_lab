    ...
    <div class="shop-layout">
        ...
        <aside class="sidebar">
          ...
          <div class="filter-body" id="filter-ingredient">
            <label><input type="checkbox" value="alpCentella" onchange="applyFilters()"> Alpha Centella <span
                class="count">(1)</span></label>
            <label><input type="checkbox" value="Centella" onchange="applyFilters()"> Centella <span
                class="count">(1)</span></label>
            <label><input type="checkbox" value="Niacinamide-acid " onchange="applyFilters()"> Niacinamide-acid  <span
                class="count">(1)</span></label>
            <label><input type="checkbox" value="Centella" onchange="applyFilters()"> Centella Asiatica (Cica) <span
                class="count">(2)</span></label>
            <label><input type="checkbox" value="Centella" onchange="applyFilters()"> Ferulic Acid <span
                class="count">(1)</span></label>
            <label><input type="checkbox" value="Niacinamide-acid" onchange="applyFilters()"> Niacinamide Acid <span
                class="count">(1)</span></label>
          </div>
            ...
            <div class="filter-group">
                ...
                <div class="filter-body" id="filter-ingredient">
                    <label><input type="checkbox" value="Centella" onchange="applyFilters()"> Centella Asiatica (Cica) <span
                            class="count">(1)</span></label>
                    <label><input type="checkbox" value="New-gen" onchange="applyFilters()"> New-Gen UV Filters <span
                            class="count">(1)</span></label>
                    <label><input type="checkbox" value="Niacinamide" onchange="applyFilters()"> Niacinamide <span
                            class="count">(1)</span></label>

                    <label><input type="checkbox" value="panthenol" onchange="applyFilters()"> Panthenol & Aquaxyl <span
                            class="count">(1)</span></label>
                    ...
                    <label><input type="checkbox" value="Thermus" onchange="applyFilters()"> Thermus Thermophilus Ferment<span
                            class="count">(1)</span></label>


                    <label><input type="checkbox" value="Uv-filters" onchange="applyFilters()"> UV Filters<span
                            class="count">(1)</span></label>


                    <label><input type="checkbox" value="zinc" onchange="applyFilters()"> Zinc Oxide <span
                            class="count">(1)</span></label>
          ...
          <label><input type="checkbox" value="Centella" onchange="applyFilters()"> Centella <span
            ...
            <div class="filter-group">
                ...
                <div class="filter-body" id="filter-type">
                    <label><input type="checkbox" value="Sunscreens" onchange="applyFilters()"> Sunscreens <span
                            class="count">(2)</span></label>
        ...
        <div class="product-grid-wrap">
            ...
            <div class="products-grid" id="productsGrid">
                ...
                <!-- PRODUCT 2 -->
                <div class="product-card" data-price="699" data-concern="pigmentation" data-ingredient="New-gen"
                    data-type="lotus_moisturizers">
                    <a href="niacinamide_oil_free_moisturizer.php">
                        <div class="product-img-wrap">
                ...
                <!-- PRODUCT 3 -->
                <div class="product-card" data-price="699" data-concern="brightening" data-ingredient="Niacinamide"
                    data-type="lotus_moisturizers">
                    <a href="niacinamide_dry_touch_matte_sunscreen.php">
                        <div class="product-img-wrap">
                        ...
                        <div class="product-info">
                            <div class="product-name">Niacinamide Dry Touch Matte Sunscreen</div>
                            <div class="product-sub">/ Provides broad-spectrum UVA and UVB protection, oil control, and a smooth matte finish /</div>
                ...
                <!-- PRODUCT 4 -->
                <div class="product-card" data-price="699" data-concern="eczema" data-ingredient="panthenol "
                    data-type="lotus_moisturizers">a
                    <a href="vitamin_c_brightening_serum.php">
                        ...
                        <div class="product-info">
                            ...
                            <div><span class="stars">★★★★</span><span class="review-count">( 154 reviews)</span></div>
                            <div class="product-price">₹699</div>
                            <span class="bought-tag">58+ bought in past month</span>
                ...
                <!-- PRODUCT 5 -->
                <div class="product-card" data-price="649" data-concern="acne" data-ingredient="Uv-filters"
                    data-type="lotus_moisturizers">
                ...
                <!-- PRODUCT 6 -->
                <div class="product-card" data-price="495" data-concern="acne" data-ingredient="zinc"
                ...
                <!-- PRODUCT 7 -->
                <div class="product-card" data-price="649" data-concern="hydration" data-ingredient="Thermus"
                    data-type="lotus_moisturizers">
                    <div class="product-img-wrap">
