...
<div class="breadcrumb-row">
  <a href="#">Home</a> / Face Serums &amp; Treatments
</div>

<!-- PAGE TITLE -->
<h1 class="page-title">Face Serums &amp; Treatments</h1>
    ...
    <aside class="sidebar">
      ...
      <div class="filter-group">
        ...
        <div class="filter-body" id="filter-concern">
          ...
          <label><input type="checkbox" value="lines-wrinkles" onchange="applyFilters()"> Lines and Wrinkles <span
              class="count">(1)</span></label>
      ...
      <div class="filter-group">
        ...
        <div class="filter-body" id="filter-ingredient">
          <label><input type="checkbox" value="alpha-arbutin" onchange="applyFilters()"> Alpha Arbutin <span
              class="count">(1)</span></label>
          <label><input type="checkbox" value="arbutin" onchange="applyFilters()"> Arbutin <span
              class="count">(1)</span></label>
          <label><input type="checkbox" value="bakuchiol" onchange="applyFilters()"> Bakuchiol <span
              class="count">(1)</span></label>
          <label><input type="checkbox" value="centella" onchange="applyFilters()"> Centella Asiatica (Cica) <span
              class="count">(2)</span></label>
          <label><input type="checkbox" value="ferulic-acid" onchange="applyFilters()"> Ferulic Acid <span
              class="count">(1)</span></label>
      ...
      <div class="filter-group">
        ...
        <div class="filter-body" id="filter-type">
          <label><input type="checkbox" value="acne-kit" onchange="applyFilters()"> Acne Treatments &amp; Kits <span
              class="count">(1)</span></label>
          <label><input type="checkbox" value="face-serum" onchange="applyFilters()"> Face Serums <span
